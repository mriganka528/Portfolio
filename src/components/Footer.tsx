...
function Footer() {
    return (
        <div className='w-screen px-9 sm:px-20 flex justify-between items-center py-3 footer border z-10 border-t-[#33353F] border-l-transparent border-r-transparent text-white'>
